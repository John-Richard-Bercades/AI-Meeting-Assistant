...
const MeetingMinutesList = () => {
    ...
    const handleRowClick = (title) => {
        // Assuming each meeting has a unique ID, you can use the title as a temporary ID
                    ...
                    <table style={{ 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style={{...tableHeaderStyle, width: '20%'}}>Created At</th>
                                <th style={{...tableHeaderStyle, width: '20%'}}>Updated At</th>
                                <th style={{...tableHeaderStyle, width: '10%'}}>Edit</th>
                                <th style={{...tableHeaderStyle, width: '12%'}}>Download</th>
                                <th style={{...tableHeaderStyle, width: '10%'}}>Delete</th>
                            </tr>
                        </thead>
                        <tbody>
                            {MeetingMinutesList.map((meeting, index) => (
                                ...
                                >
                                    ...
                                    <td style={{...tableDataStyle, textAlign: 'center'}}>
                                        <ActionButton 
                                            onClick={(e) => handleDownload(e, meeting.title)}
                                        >
                                            Download
                                        </ActionButton>
                                    </td>
